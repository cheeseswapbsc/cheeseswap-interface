!function () {
  ...
  function e() {
    ...
    (n = console.warn || console.log).call.apply(n, [
      console,
      '[ROCKET LOADER] '
    ].concat(t));
    var n
  ...
  C = function () {
    ...
    t.prototype.write = function (t, e) {
      ...
      n && i(n) && n.hasAttribute('async') ? (r = e ? _ : L).call.apply(r, [
        document
      ].concat(t)) : this.buffer += t.map(String).join(e ? '\n' : '');
      var r
    },
    t
  }(),
  j = function () {
    ...
    t.prototype.patchEventTargetMethods = function (t) {
      ...
      t.addEventListener = function (t, r) {
        for (var o = [
        ], i = 2; i < arguments.length; i++) o[i - 2] = arguments[i];
        var a = m(this),
      ...
      t.removeEventListener = function (t, e) {
        for (var n = [
        ], o = 2; o < arguments.length; o++) n[o - 2] = arguments[o];
